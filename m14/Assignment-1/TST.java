...
class TST<Value> {
     ...
     * given key if the key is in the
     *             symbol table and {@code null}
     ...
     * value with the new value if the key
     * is already in the symbol table. If
     * the value is {@code null}, this
     * effectivelydeletes the key from the
     * symbol table.
     *
     * @param      key   the key
     * @param      val   the value
     ...
     * that is the longest prefix of
     *             {@code query}, or {@code null}
     *             if no such string
     * @throws     IllegalArgumentException
     ...
     * symbol table that match {@code
     *             pattern}, as an iterable,
     *             where . is treated as a wildcard
     *             character.
     */
