...
//         try {
//             File synsetfile = new File("Files/" + syn);
//             Scanner sf = new Scanner(synsetfile);
...
//     // a synset (second field of synset.txt) that is the common ancestor of nounA and nounB
...
public class WordNet {
     ...
     */
    public WordNet(final String synset, final String hypernyms) {
        try {
